...
import com.android.server.zbt.BluetoothProxyService;
            ...
            switch (msg.what) {
                ...
                case MESSAGE_BLUETOOTH_SERVICE_CONNECTED: {
                    ...
                    try {
                        ...
                        mBinding = false;
                        BluetoothProxyService proxyService = new BluetoothProxyService();
                        ServiceManager.addService("bluetoothforwarderservice", proxyService);
                        mBluetoothBinder = ServiceManager.getService("bluetoothforwarderservice");
                        mBluetooth = IBluetooth.Stub.asInterface(Binder.allowBlocking(ServiceManager.getService("bluetoothforwarderservice")));
