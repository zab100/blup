...
public class HidDeviceNativeInterface {
    ...
    public boolean registerApp(String name, String description, String provider,
        ...
        return registerAppWindows(name, description, provider, subclass, descriptors, inQos, outQos);
    }
    ...
    public boolean sendReport(int id, byte[] data) {
        return sendReportWindows(id, data);
    }
    ...
    public boolean replyReport(byte type, byte id, byte[] data) {
        return replyReportWindows(type, id, data);
    }
    ...
    public boolean connect(BluetoothDevice device) {
        return connectWindows(getByteAddress(device));
    }
    ...
    public boolean reportError(byte error) {
        return reportErrorWindows(error);
    }
    ...
    private native boolean registerAppNative(String name, String description, String provider, byte subclass, byte[] descriptors, int[] inQos, int[] outQos);
    ...
    private boolean registerAppWindows(String name, String description, String provider, byte subclass, byte[] descriptors, int[] inQos, int[] outQos){
        Log.e("MODIFYANDROIDHID", "register app windows " + name);
        return false;
    }

    private boolean unregisterAppWindows(){
        Log.e("MODIFYANDROIDHID", "unregister app windows ");
        return false;
    }

    private boolean sendReportWindows(int id, byte[] data){
        Log.e("MODIFYANDROIDHID", "send report windows ");
        return false;
    }

    private boolean replyReportWindows(byte type, byte id, byte[] data){
        Log.e("MODIFYANDROIDHID", "reply report windows");
        return false;
    }

    private boolean unplugWindows(){
        Log.e("MODIFYANDROIDHID", "unplug windows ");
        return false;
    }

    private boolean connectWindows(byte[] btAddress){
        Log.e("MODIFYANDROIDHID", "connect windows " + Utils.byteArrayToString(btAddress));
        return false;
    }

    private boolean disconnectWindows(){
        Log.e("MODIFYANDROIDHID", "disconnect windows");
        return false;
    }

    private boolean reportErrorWindows(byte error){
        Log.e("MODIFYANDROIDHID", "report error windows ");
        return false;
    }
}
